...
export default function PhotosUploader({addedPhotos,onChange}){
    ...
    async function addPhotoByLink(ev) {
      ...
      function removePhoto(ev, filename) {
        // Prevent the default action of the event (like preventing a form submission)
        ev.preventDefault();
        
        // Create a new array excluding the photo with the specified filename
      ...
      function selectAsMainPhoto(ev, filename) {
        ...
        // Create a new array with the selected photo at the first position
